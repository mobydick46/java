...
////////////此处作enter tab等效切换/////////////////////
      ...
      reset:function(){
        ...
        $inp.bind('keydown', function (e) {
            ...
            if (key == 13) {
                ...
                var op= $(":input:text:eq(" + nxtIdx + ")");
                try{
                  op.combobox('textbox').focus();
                }catch(e){
                  op.focus();
                  }
            }
       ...
       //适配combobox
        $(".easyui-combobox").each(function(){
            var op=$(this);
                  op.combobox('textbox').bind('focus',function(){  
                        if(op.combobox('options').readonly==true){
                              return;
                        }     
                        op.combobox('showPanel');  
                }); 

                 op.combobox('textbox').bind('keydown',function(e){  
                        var key = e.which;
                        if(key==13){
                               op.combobox('hidePanel');  
                        }
                });
            });
        ...
        $(".easyui-combotree").each(function(){
            var op=$(this);
                  op.combotree('textbox').bind('focus',function(){  
                        if(op.combotree('options').readonly==true){
                              return;
                        }     
                        op.combotree('showPanel');  
                }); 

                 op.combotree('textbox').bind('keydown',function(e){  
                        var key = e.which;
                        if(key==13){
                               op.combotree('hidePanel');  
                        }
                });
            });
        ...
        $(".easyui-datebox").each(function(){
            var op=$(this);
                  op.datebox('textbox').bind('focus',function(){  
                        if(op.datebox('options').readonly==true){
                              return;
                        }     
                        op.datebox('showPanel');  
                }); 

                 op.datebox('textbox').bind('keydown',function(e){  
                        var key = e.which;
                        if(key==13){
                               op.datebox('hidePanel');  
                        }
                });
            });
        ...
        $(".easyui-datetimebox").each(function(){
            var op=$(this);
                  op.datetimebox('textbox').bind('focus',function(){  
                        if(op.datetimebox('options').readonly==true){
                              return;
                        }     
                        op.datetimebox('showPanel');  
                }); 

                 op.datetimebox('textbox').bind('keydown',function(e){  
                        var key = e.which;
                        if(key==13){
                               op.datetimebox('hidePanel');  
                        }
                });
            });
    ...
    window._ENTER_IS_NEXT = ENTER_TAB_EQ;
  //////////////////////////////////////////////////////////////////////////////////////
